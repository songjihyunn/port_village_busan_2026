...
src/
├── app/
│   ├── staff/[role]/page.tsx    # 역할별 스태프 페이지
│   └── admin/                    # 관리자 대시보드
├── components/
│   ├── PanoramaViewer.tsx        # Three.js 360° 뷰어
│   └── admin/
│       ├── MapTab.tsx            # SVG 인터랙티브 지도
│       ├── DashboardTab.tsx      # 혼잡도 대시보드
│       ├── StaffTab.tsx
│       ├── ManualTab.tsx
│       └── TrainingTab.tsx
├── lib/supabase/
...
└── types/
supabase/
└── schema.sql                    # 12개 테이블 + congestion_level_trigger
